...
local palette = require('rider_melon.palette')
local highlights = require('rider_melon.highlights')
local terminal = require('rider_melon.terminal')
...
vim.api.nvim_create_autocmd("OptionSet", 
{
  ...
  callback = function()
    ...
    pcall(require('rider_melon.theme').load)
  end,
})
